...
<div class="login">
    ...
    <form method="post" action="${re.contextPath}/login" class="layui-form" >
        <input name="username" placeholder="用户名" value="${username}" autocomplete="off"  type="text" lay-verify="username" class="layui-input" >
        <hr class="hr15">
    ...
    <a href="/pdms/tenant/register" class="layui-btn layui-btn-normal">注册租户</a>
</div>
