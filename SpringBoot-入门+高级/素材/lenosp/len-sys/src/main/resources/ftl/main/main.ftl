...
<#if showTenant == true>
    <div style="position: fixed;top:50px;bottom: 0px;border: 1px solid red;background: #dddddd;width: 100%;z-index: 999;overflow: auto">
                            ...
                            <div class="layui-card">
                                ...
                                <div class="layui-card-body" style="height: 130px;overflow: auto;">
                                    ...
                                    <#list projects as project>
                                        <div tag="project" data-tid="${tanant.id}" tid="${tenant.id}" pid="${project.id}" pname="${project.projectName}" class="project-box">
