...
public class RoleController extends BaseController {
    ...
    public ReType showRoleList(SysRole role, Model model, int page, int limit) {
        role.setTenantId((String) Principal.getSession().getAttribute("globalTenantId"));
        Page<?> tPage = PageHelper.startPage(page, limit);
        List<SysRole> roleList = roleService.selectListByPage(role);
        return new ReType(tPage.getTotal(),roleList);
    }
